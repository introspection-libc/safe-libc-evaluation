...
#define GM_BUILD_CFLAGS "-fopenmp -mmpx -fcheck-pointer-bounds -g -O0 -include /home/manuel/git/safec/libc.h -Wall -pthread"

/* arguments passed to configure */
#define GM_BUILD_CONFIGURE_ARGS "./configure  'CC=gcc' 'CXX=g++' 'CFLAGS=-mmpx -fcheck-pointer-bounds -g -O0 -include /home/manuel/git/safec/libc.h' 'CXXFLAGS=-mmpx -fcheck-pointer-bounds -g -O0 -include /home/manuel/git/safec/libc.h' 'LDFLAGS=-lmpx -lmpxwrappers -O3 -Wl,-E' 'LIBS=/home/manuel/git/safec/libc-mpx.o /home/manuel/git/safec/mpx.o'"
...
#define GM_BUILD_CXXFLAGS "-mmpx -fcheck-pointer-bounds -g -O0 -include /home/manuel/git/safec/libc.h -pthread"

/* Host identification triplet */
#define GM_BUILD_HOST "x86_64-unknown-linux-gnu"

/* LDFLAGS used for linking */
#define GM_BUILD_LDFLAGS "-lmpx -lmpxwrappers -O3 -Wl,-E"

/* LIBS used for linking */
#define GM_BUILD_LIBS "/home/manuel/git/safec/libc-mpx.o /home/manuel/git/safec/mpx.o -ljbig -ltiff -lfreetype -ljpeg -lpng12 -lXext -lSM -lICE -lX11 -llzma -lbz2 -lxml2 -lz -lm -lgomp -lpthread"
...
#define MISSING_STD_IOS_BINARY /**/

/* Directory where executables are installed. */
#define MagickBinPath "/usr/local/bin/"

/* Location of coder modules */
#define MagickCoderModulesPath "/usr/local/lib/GraphicsMagick-1.3.26/modules-Q8/coders/"

/* Subdirectory of lib where coder modules are installed */
#define MagickCoderModulesSubdir "GraphicsMagick-1.3.26/modules-Q8/coders"

/* Location of filter modules */
#define MagickFilterModulesPath "/usr/local/lib/GraphicsMagick-1.3.26/modules-Q8/filters/"

/* Subdirectory of lib where filter modules are installed */
#define MagickFilterModulesSubdir "GraphicsMagick-1.3.26/modules-Q8/filters"

/* Directory where architecture-dependent configuration files live. */
#define MagickLibConfigPath "/usr/local/lib/GraphicsMagick-1.3.26/config/"

/* Subdirectory of lib where architecture-dependent configuration files live.
   */
#define MagickLibConfigSubDir "GraphicsMagick-1.3.26/config"

/* Directory where architecture-dependent files live. */
#define MagickLibPath "/usr/local/lib/GraphicsMagick-1.3.26/"

/* Subdirectory of lib where GraphicsMagick architecture dependent files are
   installed */
#define MagickLibSubdir "GraphicsMagick-1.3.26"

/* Directory where architecture-independent configuration files live. */
#define MagickShareConfigPath "/usr/local/share/GraphicsMagick-1.3.26/config/"

/* Subdirectory of lib where architecture-independent configuration files
   live. */
#define MagickShareConfigSubDir "GraphicsMagick-1.3.26/config"

/* Directory where architecture-independent files live. */
#define MagickSharePath "/usr/local/share/GraphicsMagick-1.3.26/"
